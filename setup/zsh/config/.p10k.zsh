# Generated by Powerlevel10k configuration wizard on 2024-08-17 at 11:59 CST.
...
# lightest, 24h time, angled separators, sharp heads, round tails, 2 lines, solid,
# no frame, sparse, few icons, concise, transient_prompt, instant_prompt=quiet.
